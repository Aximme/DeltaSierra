...
.form-check-input {
    background-color: rgb(24, 26, 27); border-color: initial; 
}
.form-check-input:focus {
    outline-color: initial; box-shadow: none; 
}
...
.input-group .form-control:focus {
    border-left-color: rgb(113, 30, 97) !important;
    border-right-color: rgb(113, 30, 97) !important;
}
...
.bg-gradient-faded-primary {
    background-image: radial-gradient(370px at 80% 50%,
...
.bg-gradient-faded-primary-vertical {
    background-image: radial-gradient(200px at 50% 70%,
...
.flatpickr-calendar.multiMonth .flatpickr-days .dayContainer:nth-child(n+2) .flatpickr-day.inRange:nth-child(7n+1) {
    box-shadow: rgb(38, 41, 43) -2px 0px 0px,
    rgb(38, 41, 43) 5px 0px 0px;
}
...
.flatpickr-day.inRange {
    box-shadow: rgb(38, 41, 43) -5px 0px 0px,
    rgb(38, 41, 43) 5px 0px 0px;
}
...
.flatpickr-day.week.selected {
    box-shadow: rgb(7, 72, 150) -5px 0px 0px,
    rgb(7, 72, 150) 5px 0px 0px;
}
...
.flatpickr-calendar .flatpickr-day.inRange {
    ...
    border-color: initial;
    box-shadow: rgb(37, 40, 42) -5px 0px 0px,
    rgb(37, 40, 42) 5px 0px 0px;
}
...
.select2-container--default .select2-selection--multiple .select2-selection__choice__remove {
    ...
    border-bottom-color: initial;
    border-left-color: initial;
    border-right-color: rgb(72, 78, 81);
    color: rgb(168, 160, 149);
}
.select2-container--default .select2-selection--multiple .select2-selection__choice__remove:hover,
.select2-container--default .select2-selection--multiple .select2-selection__choice__remove:focus {
    background-color: rgb(32, 35, 36);
    color: rgb(200, 195, 188); outline-color: initial; 
}
...
.select2-container--classic .select2-selection--single {
    ...
    border-color: rgb(72, 78, 81);
    outline-color: initial;
    background-image: linear-gradient(rgb(24, 26, 27) 50%,
    rgb(34, 36, 38) 100%);
}
...
.select2-container--classic .select2-selection--single .select2-selection__arrow {
    ...
    border-bottom-color: initial;
    border-left-color: rgb(72, 78, 81);
    background-image: linear-gradient(rgb(34, 36, 38) 50%,
    rgb(53, 57, 59) 100%);
}
